...
export class TasksPage extends Component {
  ...
  componentWillMount() {
    ...
    this
      .props
      .filterTasks(this.getFilterParam(this.props.location.search));
  }
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.location.search !== this.props.location.search) {
      this
        .props
        .filterTasks(this.getFilterParam(nextProps.location.search));
    }
  }
...
const mapStateToProps = createSelector(getNotification, getTaskFilter, getVisibleTasks, (notification, filterType, tasks) => ({notification, filterType, tasks}));
